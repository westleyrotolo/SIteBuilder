...
Vue.component("banner-block", {
    ...
    data: function () {
        return {
            ...
            buttonColor: this.model.buttonColor.value,
            buttonUrl: this.model.buttonUrl.value,
            buttonText: this.model.buttonText.value,
            uid2: this.uid + "2"
        };
    },
    methods: {
    ...
    template:
        ...
        "          <input type='text' style='width:100%;height:3em' class='form-control form-control-color' :id='uid' v-model='model.buttonText.value'  title = 'Titolo' > " +
        "      </div>" +
        "   </div>" +
        "   <br />" +
        "   <div class='text-block'>" +
        "       <div class='block-body rounded'  >" +
        "          <input type='text' style='width:100%;height:3em' class='form-control form-control-color' :id='uid' v-model='model.buttonUrl.value'  title = 'Url' > " +
        "      </div>" +
        "   </div>" +
        "   <br />" +
        "   <div class='color-block'>" +
        "       <div class='block-body rounded'  >" +
        "          <input type='color' style='width:4em;height:3em' class='form-control form-control-color' :id='uid' v-model='model.buttonColor.value'  title = 'Choose your color' > " +
        "      </div>" +
        "   </div>" +
        "   <br />" +
        "</div>"
